...
const GIFT_TERMS_DEFAULT =
  ...
  <h4>ご注意</h4>
  <ul>
    <li>複数のキャンペーンでお申し込みをいただいた場合、初回面談までの期間で最初にお申し込みいただいたキャンペーンが適用されます。<br>
    ※別キャンペーンへの変更はできかねます。</li>
...
const GIFT_TERMS_CAMPAIGN =
  `<h3>えらべるデジタルギフト<br>プレゼント条件</h3>
  <h4>【個別面談・Web面談をお申込みのお客様】</h4>
  <p>プレゼントは、Web面談で20,000円、オフライン（対面）個別面談で50,000円相当のえらべるデジタルギフトを予定しております。<br>
  <br>
  【期間限定・先着100名様キャンペーン実施中！】<br>
  2026年8月3日(月) 00:00～2026年10月30日(金) 23:59の期間中にお申し込みいただいた方限定（先着100名様）で、プレゼント金額を10,000円UPいたします。<br>
  Web面談：30,000円相当（通常 20,000円相当）<br>
  オフライン（対面）個別面談：60,000円相当（通常 50,000円相当）<br>
  <br>
  面談でえらべるデジタルギフトプレゼントは以下の条件を満たした方が対象となります。なお、Web面談、個別面談において当社のコンサルタントと当社オフィスもしくは当社オフィス外、ウェブ通信にて対面し、当社サービスの十分な説明とお客様についての十分な（数回にわたり）情報を相互に交換することが要件となります。<br>
  また、えらべるデジタルギフトではAmazonギフトカード、PayPayマネーライト、楽天ポイントからご希望の1種のみを選択いただけます。<br>
  ご希望のポイントは、フォームの「ご質問・ご要望」欄に記入ください。お申し込み時にご記入がない場合は、Amazonギフトカードをプレゼントいたします。お申し込み完了後の変更は原則受け付けておりませんので、予めご了承ください。<br>
  ※お電話内容や商談の様子は弊社サービスへのお問い合わせ対応及びサービス改善のため録画・録音しております。予めご了承ください。<br>
  ※獲得いただける楽天ポイントは期間限定ポイントになり、有効期限はポイント獲得後、6ヶ月間です。</p>
  ...
  <h4>プレゼント対象者の条件</h4>
  <p>下記のすべての項⽬を満たしている⽅が対象になります。<br>
  <br>
  【期間限定・先着100名様キャンペーンの対象条件】<br>
  ※10,000円UPの増額対象となるのは、2026年8月3日(月) 00:00～2026年10月30日(金) 23:59の期間中にフォームよりお申し込みを完了し（先着100名様まで）、かつ以下の条件（お申し込みから90日以内の面談完了等）を満たした方となります。<br>
  ※先着の判定は、フォームからの「お申し込み完了日時」の順とさせていただきます。<br>
  ※期間内であってもお申し込みが100名様に達した時点、またはキャンペーン期間が終了した時点のいずれか早い方で本増額キャンペーンは終了となります。なお、100名様を超えたお申し込みにつきましては、通常金額（Web面談：20,000円相当／対面個別面談：50,000円相当）での進呈となります。
  </p>
  <br>
  <ul>
    <li>①年収700万円以上の方（※主婦、パートの方は、配偶者様の年収が700万円以上の場合に対象となります）</li>
  ...
  <ul>
    ...
    <li>現物でのギフトカードの贈呈はございません。</li>
    <li>特典はメールにてお渡しいたします（当社指定の⽅法による）。</li>
    <li>特典付与のタイミングは⾯談から90⽇後頃を想定しております。（※増額キャンペーン分の進呈も、通常特典と同時期となります）</li>
    <li>本キャンペーンはJ.P.RETURNS株式会社による提供です。本キャンペーンについてのお問い合わせはAmazon・PayPay・楽天でお受けしておりません。J.P.RETURNS株式会社 キャンペーン事務局（0120-147-104）までお願いいたします。</li>
    <li>Amazon、Amazon.co.jpおよびそれらのロゴはAmazon.com,Inc.またはその関連会社の商標です。</li>
    <li>PayPay ギフトカードで付与の場合、PayPay/PayPay カード公式ストアでも利用可能です。出金・譲渡不可になります。</li>
    <li>楽天ポイントおよびそのロゴは、楽天グループ株式会社の登録商標です。</li>
    <li>キャンペーン参加等により被った一切の損害について、当社は責任を負わないものとします。</li>
    <li>当社は、諸事情等により、予告なく本キャンペーンの内容の全部または一部を変更したり、本キャンペーンの適正な運用を確保するために必要と判断した措置を講じることができたり、本キャンペーンを早期に終了したりすることができるものとします。</li>
    <li>複数のキャンペーンでお申し込みをいただいた場合、初回面談までの期間で最初にお申し込みいただいたキャンペーンが適用されます。※別キャンペーンへの変更はできかねます。</li>
    <li>プレゼントの付与対象とならなかった場合、メール等で連絡されることはありません。お断りの理由については一切お答えができませんのでご了承ください。</li>
    <li>お申し込み前に、必ずページ内に記載の「取り扱い商品の特徴」をご確認ください。</li>
    <li>上記条件を全て満たしていなくても、ご成約後、特典を進呈する場合があります。なお、この場合、付与決定までは「付与保留」の取り扱いとさせていただきますので、ご了承ください。<br>
    （例）<br>
...
const initialQuestions = [
  ...
  },
  {
    ...
    key: "phone_number",
    validation: (v) => {
      const digits = v.replace(/[ー－‐-]/g, "").trim();
      // 1. 先頭が0で始まる10〜11桁の数字
      const isValidLength = /^0\d{9,10}$/.test(digits);
      // 2. 全て同じ数字の繰り返しを禁止
      const isNotRepeated = !/^(.)\1+$/.test(digits);
