// js/questions.js (Modified for AB Test with summaryLabel)
// 質問の定義データ
...
const questions = [
    ...
    { id: 2, item: "面談希望時間（第一希望）", summaryLabel: "第1希望 時間", question: "【第1希望】<br>ご相談希望時間をお選びください", isHtmlQuestion: true, answer_method: "single-choice",
      options: [
        ...
        { label: "その他の時間", value: "その他の時間" },
      ],
      key: "first_choice_time", validation: (v) => !!v, errorMessage: "選択してください。"
   },
    { id: 3, item: "面談希望時間（第一希望その他）", summaryLabel: "第1希望 時間(その他)", question: "【第1希望】ご相談希望時間を入力ください", answer_method: "text", type: "text", key: "first_choice_time_other", condition: { key: "first_choice_time", value: "その他の時間" }, validation: (v) => v && v.trim().length > 0, errorMessage: "希望時間を入力してください。" },
    { id: 4, item: "面談希望日（第二希望）", summaryLabel: "第2希望 日程", question: "【第2希望】<br>ご相談希望日をお選びください", isHtmlQuestion: true, answer_method: "calendar", key: "second_choice_date", validation: (v) => /^\d{4}\/(0?[1-9]|1[0-2])\/(0?[1-9]|[12][0-9]|3[01])$/.test(v) && !isNaN(new Date(v)), errorMessage: "YYYY/MM/DD形式で有効な日付を入力してください。" },
    { id: 5, item: "面談希望時間（第二希望）", summaryLabel: "第2希望 時間", question: "【第2希望】<br>ご相談希望時間をお選びください", isHtmlQuestion: true, answer_method: "single-choice",
      options: [
        { label: "10:00～12:00", value: "10：00～12：00" },
        { label: "12:00～14:00", value: "12：00～14：00" },
        { label: "14:00～16:00", value: "14：00～16：00" },
    ...
    { id: 8, item: "年収", summaryLabel: "ご年収", question: "続いて、現在の年収を教えてください。", answer_method: "single-choice", 
      options: [
    ...
    { id: 9, item: "年齢", summaryLabel: "ご年齢", question: "ご年齢はおいくつでしょうか？", answer_method: "single-choice", options: ["20歳未満", "20～24歳", "25～29歳", "30～34歳", "35～39歳", "40～44歳", "45～49歳", "50～54歳", "55～59歳", "60～64歳", "65～69歳", "70歳以上"], key: "age_group", validation: (v) => !!v, errorMessage: "選択してください。" },
    { id: 10, item: "お名前（漢字）", pre_message_1: "ありがとうございます！", answer_method: "text-pair", pairs: [
    ...
    { id: 11, item: "お名前（フリガナ）", answer_method: "text-pair", pairs: [
    ...
    { id: 12, item: "電話番号", summaryLabel: "電話番号", pre_message_1: "残り2問です！", question: "電話番号を入力してください。", placeholder: "09012345678", answer_method: "text", type: "tel", key: "phone_number", validation: (v) => /^[0-9]{10,11}$/.test(v.replace(/-/g, "")), errorMessage: "有効な電話番号をハイフンなし半角数字で入力してください。" },
    { id: 13, item: "メールアドレス", summaryLabel: "メールアドレス", question: "最後に、メールアドレスを入力してください！", placeholder: "user@example.com", answer_method: "text", type: "email", key: "email_address", validation: (v) => /^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(v), errorMessage: "有効なメールアドレスを入力してください。" },
    {
      id: 14,
      item: "最終確認",
      ...
      gift_terms_popup_content: `
        ...
        <ul>
            <li>世帯で初めて「J.P.リターンズ」のサービスを利⽤（セミナー受講、プライベートセミナー、⾯談、資料請求、動画セミナー）する⽅</li>
            <li>予約申込後、90⽇以内に個別相談を完了された⽅（本⼈確認必須。Web⾯談の場合、カメラON、お顔が⾒える状態で⾯談をお願いします。）</li>
            <li>⾯談(web以外も含め)に3回以上ご参加いただいた⽅<br>※お客様のご状況や提案状況に応じて、複数回の⾯談を実施する場合がございます。</li>
            <li>上場企業、それに準ずる企業（＝資本⾦1億円以上）、またはそのグループ会社にお勤めの⽅、もしくは医師、公務員、看護師、薬剤師として現在お勤めの⽅</li>
            <li>年収700万円以上の方</li>
            <li>勤続年数が2年以上かつ25歳以上50歳未満の方<br>※主婦、パートの⽅は配偶者の年収が700万円以上の場合、「年収700万円以上の⽅」と判断する場合もございます。</li>
            <li>フォームよりお申込後、メールでお送りした属性アンケートにご回答頂いた内容、もしくは、営業担当がヒアリングした内容が上記の年収、勤続年数などの条件を満たした⽅</li>
            <li>事前に「社会健康保険証」をご提出いただいた方(データ送付・もしくは画面にて提示)</li>
            <li>WebカメラやFacetime等、テレビ通話を通じて対面で面談が出来る方（お顔を隠さず、Face to Faceで面談できる方）</li>
        ...
        <ul>
            ...
            <li>お申込後、事前に「社会健康保険証」をデータ送付頂けない方（または、当日、画面にて呈示頂けない方）</li>
            ...
            <li>不動産購入に対して決裁権がご自身にない場合またはご相談が必要な場合、決裁権のある方またはご相談者（配偶者等）同席での面談を別途実施出来ると確認できない方</li>
        ...
        <ul>
            ...
            <li>当社で取り扱いの無い投資⼿法やサービスをご希望される場合<br>※投資条件（取り扱いエリア・物件種別・平均利回りなど）に当てはまらない場合<br>※ご希望される内容が、当社の商品やサービスにマッチしない場合</li>
        ...
        <ul>
            ...
            <li>PayPay ギフトカードで付与。PayPay/PayPay カード公式ストアでも利用可能です。出金・譲渡不可になります。</li>
            <li>お申し込み前に、必ずページ内に記載の「取り扱い商品の特徴」をご確認ください。</li>
            <li>上記条件を全て満たしていなくても、ご成約後、特典を進呈する場合があります。なお、この場合、付与決定までは「付与保留」の取り扱いとさせていただきますので、ご了承ください。<br>（例）<br>・現⾦で投資⽤不動産をご購⼊いただけた⽅<br>・頭⾦として現⾦をお⽀払いいただくことにより、投資⽤不動産をご購⼊いただけた⽅<br>・年収700万円未満または勤続2年未満でも、当社提携の⾦融機関から融資を受け、投資⽤不動産をご購⼊いただけた⽅</li>
        </ul>
        <h4>当社の取り扱い商品の特徴</h4>
        <ul>
            <li><b>取り扱いエリア</b><br>⼊居率や家賃の相場が⾼い【東京・神奈川エリア】の中古区分物件を中⼼に、築年数や駅距離などの条件の良いものをセレクトし、お客様にご提案しています。<br>※⼀部、⼤阪エリア物件の取り扱いあり</li>
            <li><b>物件ラインナップ</b><br>お客様のニーズにお応えするために、低価格⾼利回り物件からファミリータイプ物件まで、様々な物件を取り扱っています。<br>＜価格帯＞1,000万〜5,000万円程度<br>＜平均利回り＞4%前後</li>
        </ul>
        <h4>ご注意</h4>
        <ul>
            ...
            <li>当社の意に沿わない場合、お断りの理由については一切お答えが出来ませんのでご了承ください。</li>
            <li>現物でのギフトカードの贈呈はございません。 特典はメールにてお渡し致します（当社指定の⽅法による）。特典付与のタイミングは⾯談から90⽇後頃を想定しております。</li>
        </ul>`,
